package com.sz.qzxkj.example.part5;
 ...
 */
public class Recv2 {
    private static final String QUEUE_NAME = "example-queue-topic-sms";
    private static final String EXCHANG_NAME = "example-exchange-01";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.queueBind(QUEUE_NAME,EXCHANG_NAME,"");//绑定队列到交换机转发器
